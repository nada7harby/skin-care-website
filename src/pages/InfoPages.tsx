        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 mb-20">
          <div className="lg:col-span-7">
            ...
            <div className="space-y-4 text-ink-muted leading-relaxed max-w-2xl">
              <p>GlowSkin was founded in 2020 with a simple mission: build skincare products that are honest about what's in them, and effective enough that you actually notice a difference.</p>
              <p>We combine dermatologist-grade actives with ingredients you can pronounce, formulated in small batches so nothing spends months sitting in a warehouse before it reaches your bathroom shelf.</p>
              <p>Every product is dermatologist-tested, cruelty-free, and reformulated when the science moves forward — not just when the packaging needs a refresh.</p>
            </div>
          </div>
...
const ContactPage: React.FC = () => (
  <div className="container-custom pt-32 pb-24">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div className="lg:col-span-7">
        <form className="bg-porcelain-paper border border-porcelain-line rounded-2xl p-7 space-y-4" onSubmit={e => e.preventDefault()}>
          ...
          <div>
            ...
            <textarea className="input min-h-[150px] resize-none" placeholder="Your message" />
          </div>
